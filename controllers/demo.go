...
//  DemoController operations for Demo
...
// @Param	body		body 	models.Demo	true		"body for Demo content"
// @Success 201 {int} models.Demo
// @Failure 403 body is empty
// @router / [post]
func (c *DemoController) Post() {
	var v models.Demo
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if _, err := models.AddDemo(&v); err == nil {
...
func (c *DemoController) GetAll() {
	...
	l, err := models.GetAllDemo(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *DemoController) Put() {
	...
	v := models.Demo{Id: id}
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if err := models.UpdateDemoById(&v); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
...
func (c *DemoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	if err := models.DeleteDemo(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
